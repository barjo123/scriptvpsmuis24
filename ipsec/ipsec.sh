...
# ==================================================
# Link Hosting Kalian
akbarvpn="raw.githubusercontent.com/kelvintan1101/scriptvps/main/ipsec"
...
touch /var/lib/techsolution11/data-user-l2tp
touch /var/lib/techsolution11/data-user-pptp
rm -f /root/ipsec.sh
